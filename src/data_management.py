...
def download_dataframe_as_csv(dfs, caps):
    ...
    href = f"""
        {button_css}<a style="text-decoration: none; color: black;"
        href="data:file/csv;base64,{b64}" download="Report_{datetime_now}.csv"
        target="_blank">Download Report</a></button>
        """
    os.remove(temp_name)
